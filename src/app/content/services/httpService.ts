...
export class HttpService {
  ...
  public post(post: Modelos.Post) {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .post(this.ip + post.url, post.data, this.optionsPOST)
        .toPromise()
        .then((response: any) => {
  ...
  public put(post: Modelos.Post) {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .put(this.ip + post.url, post.data, this.optionsPOST)
        .toPromise()
        .then((response: any) => {
          if (post.mensajeExito) {
            this.sendMessage(post.mensajeExito, "success");
  ...
  public get(get: Modelos.Get) {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .get(this.ip + get.url, this.optionsGET)
        .toPromise()
        .then((response: any) => {
  ...
  private getEstados() {
    ...
    return this.http
      .get(this.ip + "/estadistica/estados", this.optionsGET)
      .toPromise()
      .then((response: any) => {
  ...
  private putVenta(venta) {
    ...
    return this.http
      .put(
        this.ip + "/validacion/updateVenta/" + venta.id,
        venta,
        this.optionsPOST
      )
      .toPromise()
  ...
  private deleteUsuario(nombreUsuario) {
    // Helpers.setLoading(true);
    return this.http
      .delete(this.ip + "/usuario/delete/" + nombreUsuario, this.optionsGET)
      .toPromise()
      .then((response: any) => {
        // Helpers.setLoading(false);
  ...
  private postVentasPagadasArchivos(archivos: FormData) {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .post(
          "http://gestionarturnos.com/ventas/uploadAdmin.php",
          archivos,
          options
        )
        .toPromise()
