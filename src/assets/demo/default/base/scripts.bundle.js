...
var mUtil = function () {
    ...
    return {
        ...
        getURLParam: function (t) {
            var e, n, o = window.location.search.substring(1).split("&");
            for (e = 0; e < o.length; e++)
                if ((n = o[e].split("="))[0] == t) return unescape(n[1]);
            return null
        },
        ...
        deepExtend: function (t) {
            ...
            for (var e = 1; e < arguments.length; e++) {
                var n = arguments[e];
                if (n)
                    for (var o in n) n.hasOwnProperty(o) && ("object" == typeof n[o] ? t[o] = mUtil.deepExtend(t[o], n[o]) : t[o] = n[o])
            }
            return t
        },
        extend: function (t) {
        ...
        hasClasses: function (t, e) {
            if (t) {
                for (var n = e.split(" "), o = 0; o < n.length; o++)
                    if (0 == mUtil.hasClass(t, mUtil.trim(n[o]))) return !1;
                return !0
            }
        },
        ...
        addClass: function (t, e) {
            if (t && void 0 !== e) {
                var n = e.split(" ");
                if (t.classList)
                    for (var o = 0; o < n.length; o++) n[o] && n[o].length > 0 && t.classList.add(mUtil.trim(n[o]));
                else if (!mUtil.hasClass(t, e))
                    for (o = 0; o < n.length; o++) t.className += " " + mUtil.trim(n[o])
            }
        },
        removeClass: function (t, e) {
            if (t) {
                var n = e.split(" ");
                if (t.classList)
                    for (var o = 0; o < n.length; o++) t.classList.remove(mUtil.trim(n[o]));
                else if (mUtil.hasClass(t, e))
                    for (o = 0; o < n.length; o++) t.className = t.className.replace(new RegExp("\\b" + mUtil.trim(n[o]) + "\\b", "g"), "")
            }
        },
        triggerCustomEvent: function (t, e, n) {
            if (window.CustomEvent) var o = new CustomEvent(e, {
                detail: n
            });
        ...
        matches: function (t, e, n) {
            var o = Element.prototype,
                i = o.matches || o.webkitMatchesSelector || o.mozMatchesSelector || o.msMatchesSelector || function (t) {
        ...
        data: function (t) {
            return t = mUtil.get(t), {
                set: function (e, n) {
                    void 0 === t.customDataTag && (mUtilElementDataStoreID++, t.customDataTag = mUtilElementDataStoreID), void 0 === mUtilElementDataStore[t.customDataTag] && (mUtilElementDataStore[t.customDataTag] = {}), mUtilElementDataStore[t.customDataTag][e] = n
                },
                get: function (e) {
        ...
        offset: function (t) {
            var e, n;
            if (t = mUtil.get(t)) return t.getClientRects().length ? (e = t.getBoundingClientRect(), n = t.ownerDocument.defaultView, {
        ...
        animate: function (t, e, n, o, i, l) {
            var r = {};
            if (r.linear = function (t, e, n, o) {
                    return n * t / o + e
                }, i = r.linear, "number" == typeof t && "number" == typeof e && "number" == typeof n && "function" == typeof o) {
        ...
        actualCss: function (t, e, n) {
            var o;
            if (t instanceof HTMLElement != !1) return t.getAttribute("m-hidden-" + e) && !1 !== n ? parseFloat(t.getAttribute("m-hidden-" + e)) : (t.style.cssText = "position: absolute; visibility: hidden; display: block;", "width" == e ? o = t.offsetWidth : "height" == e && (o = t.offsetHeight), t.style.cssText = "", t.setAttribute("m-hidden-" + e, o), parseFloat(o))
        },
        ...
        slide: function (t, e, n, o, i) {
            if (!(!t || "up" == e && !1 === mUtil.visible(t) || "down" == e && !0 === mUtil.visible(t))) {
                ...
                var l = mUtil.actualHeight(t),
                    r = !1,
                    s = !1;
                mUtil.css(t, "padding-top") && !0 !== mUtil.data(t).has("slide-padding-top") && mUtil.data(t).set("slide-padding-top", mUtil.css(t, "padding-top")), mUtil.css(t, "padding-bottom") && !0 !== mUtil.data(t).has("slide-padding-bottom") && mUtil.data(t).set("slide-padding-bottom", mUtil.css(t, "padding-bottom")), mUtil.data(t).has("slide-padding-top") && (r = parseInt(mUtil.data(t).get("slide-padding-top"))), mUtil.data(t).has("slide-padding-bottom") && (s = parseInt(mUtil.data(t).get("slide-padding-bottom"))), "up" == e ? (t.style.cssText = "display: block; overflow: hidden;", r && mUtil.animate(0, r, n, function (e) {
                    t.style.paddingTop = r - e + "px"
                }, "linear"), s && mUtil.animate(0, s, n, function (e) {
                    t.style.paddingBottom = s - e + "px"
                }, "linear"), mUtil.animate(0, l, n, function (e) {
                    t.style.height = l - e + "px"
                }, "linear", function () {
                    o(), t.style.height = "", t.style.display = "none"
                })) : "down" == e && (t.style.cssText = "display: block; overflow: hidden;", r && mUtil.animate(0, r, n, function (e) {
                    t.style.paddingTop = e + "px"
                }, "linear", function () {
                    t.style.paddingTop = ""
                }), s && mUtil.animate(0, s, n, function (e) {
                    t.style.paddingBottom = e + "px"
                }, "linear", function () {
                    t.style.paddingBottom = ""
                }), mUtil.animate(0, l, n, function (e) {
                    t.style.height = e + "px"
                }, "linear", function () {
        ...
        on: function (t, e, n, o) {
            if (e) {
                ...
                return mUtilDelegatedEventHandlers[i] = function (n) {
                    for (var i = t.querySelectorAll(e), l = n.target; l && l !== t;) {
                        for (var r = 0, s = i.length; r < s; r++) l === i[r] && o.call(l, n);
                        l = l.parentNode
                    }
                }, mUtil.addEvent(t, n, mUtilDelegatedEventHandlers[i]), i
            }
        },
        off: function (t, e, n) {
        ...
        scrollTo: function (t, e, n) {
            n = n || 500;
            var o, i, l = (t = mUtil.get(t)) ? mUtil.offset(t).top : 0,
                r = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0;
            l > r ? (o = l, i = r) : (o = r, i = l), e && (i += e), mUtil.animate(o, i, n, function (t) {
        ...
        scrollerInit: function (t, e) {
            function n() {
                var n, o;
                o = e.height instanceof Function ? parseInt(e.height.call()) : parseInt(e.height), e.disableForMobile && mUtil.isInResponsiveRange("tablet-and-mobile") ? (n = mUtil.data(t).get("ps")) ? (e.resetHeightOnDestroy ? mUtil.css(t, "height", "auto") : (mUtil.css(t, "overflow", "auto"), o > 0 && mUtil.css(t, "height", o + "px")), n.destroy(), n = mUtil.data(t).remove("ps")) : o > 0 && (mUtil.css(t, "overflow", "auto"), mUtil.css(t, "height", o + "px")) : (o > 0 && mUtil.css(t, "height", o + "px"), mUtil.css(t, "overflow", "hidden"), (n = mUtil.data(t).get("ps")) ? n.update() : (mUtil.addClass(t, "m-scroller"), n = new PerfectScrollbar(t, {
                    wheelSpeed: .5,
                    swipeEasing: !0,
                    wheelPropagation: !1,
            ...
            n(), e.handleWindowResize && mUtil.addResizeHandler(function () {
                n()
            })
        },
...
var mHeader = function (t, e) {
                ...
                r = {
                    ...
                    build: function () {
                        ...
                        !1 === n.options.minimize.mobile && !1 === n.options.minimize.desktop || window.addEventListener("scroll", function () {
                            var e, o, l, r = 0;
                            mUtil.isInResponsiveRange("desktop") ? (r = n.options.offset.desktop, e = n.options.minimize.desktop.on, o = n.options.minimize.desktop.off) : mUtil.isInResponsiveRange("tablet-and-mobile") && (r = n.options.offset.mobile, e = n.options.minimize.mobile.on, o = n.options.minimize.mobile.off), l = window.pageYOffset, mUtil.isInResponsiveRange("tablet-and-mobile") && n.options.classic && n.options.classic.mobile || mUtil.isInResponsiveRange("desktop") && n.options.classic && n.options.classic.desktop ? l > r ? (mUtil.addClass(i, e), mUtil.removeClass(i, o)) : (mUtil.addClass(i, o), mUtil.removeClass(i, e)) : (l > r && t < l ? (mUtil.addClass(i, e), mUtil.removeClass(i, o)) : (mUtil.addClass(i, o), mUtil.removeClass(i, e)), t = l)
                        })
                    },
    ...
    mMenu = function (t, e) {
        ...
        if (i) {
                ...
                s = {
                    ...
                    handleSubmenuDropdownClick: function (t) {
                        if ("accordion" !== s.getSubmenuMode(this)) {
                            ...
                            "accordion" != e.getAttribute("m-menu-submenu-mode") && (!1 === mUtil.hasClass(e, "m-menu__item--hover") ? (mUtil.addClass(e, "m-menu__item--open-dropdown"), s.showSubmenuDropdown(e)) : (mUtil.removeClass(e, "m-menu__item--open-dropdown"), s.hideSubmenuDropdown(e, !0)), t.preventDefault())
                        }
                    },
                    ...
                    handleSubmenuDropdownClose: function (t, e) {
                        if ("accordion" !== s.getSubmenuMode(e)) {
                            ...
                            if (n.length > 0 && !1 === mUtil.hasClass(e, "m-menu__toggle") && 0 === e.querySelectorAll(".m-menu__toggle").length)
                                for (var o = 0, l = n.length; o < l; o++) s.hideSubmenuDropdown(n[0], !0)
                        }
                    },
                    handleSubmenuAccordion: function (t, e) {
                        ...
                        if ("dropdown" === s.getSubmenuMode(e) && (o = i.closest(".m-menu__item")) && "accordion" != o.getAttribute("m-menu-submenu-mode")) t.preventDefault();
                            ...
                            if (!mUtil.hasClass(i.closest(".m-menu__item"), "m-menu__item--open-always") && l && r) {
                                ...
                                } else mUtil.slideUp(r, a, function () {
                    ...
                    hideSubmenuDropdown: function (t, e) {
                        e && (mUtil.removeClass(t, "m-menu__item--hover"), mUtil.removeClass(t, "m-menu__item--active-tab")), t.removeAttribute("data-hover"), t.getAttribute("m-menu-dropdown-toggle-class") && mUtil.removeClass(l, t.getAttribute("m-menu-dropdown-toggle-class"));
                    ...
                    createSubmenuDropdownClickDropoff: function (t) {
                        var e, n = (e = mUtil.child(t, ".m-menu__submenu") ? mUtil.css(e, "z-index") : 0) - 1,
                        ...
                        l.appendChild(o), mUtil.addEvent(o, "click", function (e) {
                    ...
                    resetActiveItem: function (t) {
                        ...
                        if (!1 === n.options.accordion.expandAll && (e = i.querySelectorAll(".m-menu__item--open")))
                            for (l = 0, r = e.length; l < r; l++) mUtil.removeClass(o[0], "m-menu__item--open")
                    },
                    ...
                    getBreadcrumbs: function (t) {
                        ...
                        n.push({
                            text: e = mUtil.child(o, ".m-menu__link-text") ? e.innerHTML : "",
                        ...
                        for (var i = mUtil.parents(t, ".m-menu__item--submenu"), l = 0, r = i.length; l < r; l++) {
                            ...
                            n.push({
                                text: e = mUtil.child(s, ".m-menu__link-text") ? e.innerHTML : "",
            ...
            }, s.construct.apply(n, [e]), mUtil.addResizeHandler(function () {
                o && n.reload()
            }), o = !0, n
        }
    };
document.addEventListener("click", function (t) {
    ...
    if (e = mUtil.get("body").querySelectorAll('.m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)[m-menu-submenu-toggle="click"]'))
        for (var n = 0, o = e.length; n < o; n++) {
            ...
            if (i) {
                var l, r = mUtil.data(i).get("menu");
                if (!r) break;
                if (!r || "dropdown" !== r.getSubmenuMode()) break;
                if (t.target !== i && !1 === i.contains(t.target))
                    if (l = i.querySelectorAll('.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)[m-menu-submenu-toggle="click"]'))
                        for (var s = 0, a = l.length; s < a; s++) r.hideDropdown(l[s])
            }
        }
});
    ...
    if (o) {
        var l = {
            ...
            r = {
                ...
                init: function (t) {
                    n.options = mUtil.deepExtend({}, l, t), n.events = [], n.eventHandlers = {}, n.open = !1, n.layout = {}, n.layout.close = mUtil.find(o, ".m-dropdown__close"), n.layout.toggle = mUtil.find(o, ".m-dropdown__toggle"), n.layout.arrow = mUtil.find(o, ".m-dropdown__arrow"), n.layout.wrapper = mUtil.find(o, ".m-dropdown__wrapper"), n.layout.defaultDropPos = mUtil.hasClass(o, "m-dropdown--up") ? "up" : "down", n.layout.currentDropPos = n.layout.defaultDropPos, "hover" == mUtil.attr(o, "m-dropdown-toggle") && (n.options.toggle = "hover")
                },
                setup: function () {
                    n.options.placement && mUtil.addClass(o, "m-dropdown--" + n.options.placement), n.options.align && mUtil.addClass(o, "m-dropdown--align-" + n.options.align), n.options.width && mUtil.css(n.layout.wrapper, "width", n.options.width + "px"), "1" == mUtil.attr(o, "m-dropdown-persistent") && (n.options.persistent = !0), "hover" == n.options.toggle && mUtil.addEvent(o, "mouseout", r.hideMouseout), r.setZindex()
                },
                toggle: function () {
                ...
                show: function () {
                    ...
                    if (n.layout.arrow && r.adjustArrowPos(), r.eventTrigger("beforeShow"), r.hideOpened(), mUtil.addClass(o, "m-dropdown--open"), mUtil.isMobileDevice() && n.options.mobileOverlay) {
                        ...
                        mUtil.addClass(e, "m-dropdown__dropoff"), mUtil.css(e, "z-index", t), mUtil.data(e).set("dropdown", o), mUtil.data(o).set("dropoff", e), mUtil.addEvent(e, "click", function (t) {
                ...
                hide: function (t) {
                    return !1 === n.open ? n : (mUtil.isDesktopDevice() && "hover" == n.options.toggle ? r.hideHovered(t) : r.hideClicked(), "down" == n.layout.defaultDropPos && "up" == n.layout.currentDropPos && (mUtil.removeClass(o, "m-dropdown--up"), n.layout.arrow.prependTo(n.layout.wrapper), n.layout.currentDropPos = "down"), n)
                },
...
mUtil.on(document, '[m-dropdown-toggle="click"] .m-dropdown__toggle', "click", function (t) {
    ...
    if (e = n.querySelectorAll(".m-dropdown.m-dropdown--open"))
        for (var i = 0, l = e.length; i < l; i++) {
            ...
            mUtil.hasClass(r, "m-dropdown--disable-close") && (t.preventDefault(), t.stopPropagation()), a && o !== a && !1 === a.contains(o) && !1 === o.contains(a) ? !1 === r.contains(o) && (s.isPersistent(), s.hide()) : !1 === r.contains(o) && s.hide()
        }
});
        ...
        if (o) {
            var l = {},
                r = {
                    ...
                    init: function (t) {
                        n.events = [], n.options = mUtil.deepExtend({}, l, t), n.overlay, n.classBase = n.options.baseClass, n.classShown = n.classBase + "--on", n.classOverlay = n.classBase + "-overlay", n.state = mUtil.hasClass(o, n.classShown) ? "shown" : "hidden"
                    },
                    build: function () {
                        if (n.options.toggleBy)
                            ...
                            for (var t in n.options.toggleBy) mUtil.addEvent(n.options.toggleBy[t].target, "click", r.toggle);
                    ...
                    show: function (t) {
                        "shown" != n.state && (r.eventTrigger("beforeShow"), r.togglerClass(t, "show"), mUtil.addClass(i, n.classShown), mUtil.addClass(o, n.classShown), n.state = "shown", n.options.overlay && (n.overlay = mUtil.insertAfter(document.createElement("DIV"), o), mUtil.addClass(n.overlay, n.classOverlay), mUtil.addEvent(n.overlay, "click", function (e) {
                            e.stopPropagation(), e.preventDefault(), r.hide(t)
                        })), r.eventTrigger("afterShow"))
                    },
                    hide: function (t) {
                        "hidden" != n.state && (r.eventTrigger("beforeHide"), r.togglerClass(t, "hide"), mUtil.removeClass(i, n.classShown), mUtil.removeClass(o, n.classShown), n.state = "hidden", n.options.overlay && n.overlay && mUtil.remove(n.overlay), r.eventTrigger("afterHide"))
                    },
                    togglerClass: function (t, e) {
                        var o, i = mUtil.attr(t, "id");
                        if (n.options.toggleBy && n.options.toggleBy[0] && n.options.toggleBy[0].target)
                            for (var l in n.options.toggleBy) n.options.toggleBy[l].target === i && (o = n.options.toggleBy[l]);
        ...
        if (o) {
            var r = {
                ...
                s = {
                    ...
                    init: function (t) {
                        n.element = o, n.events = [], n.options = mUtil.deepExtend({}, r, t), n.head = mUtil.child(o, ".m-portlet__head"), n.foot = mUtil.child(o, ".m-portlet__foot"), mUtil.child(o, ".m-portlet__body") ? n.body = mUtil.child(o, ".m-portlet__body") : 0 !== mUtil.child(o, ".m-form").length && (n.body = mUtil.child(o, ".m-form"))
                    },
                    build: function () {
                        ...
                        i && mUtil.addEvent(i, "click", function (t) {
                            t.preventDefault(), s.fullscreen()
                        }), s.setupTooltips()
                    },
                    onScrollSticky: function () {
                        window.pageYOffset > n.options.sticky.offset ? !1 === mUtil.hasClass(l, "m-portlet--sticky") && (s.eventTrigger("stickyOn"), mUtil.addClass(l, "m-portlet--sticky"), mUtil.addClass(o, "m-portlet--sticky"), s.updateSticky()) : mUtil.hasClass(l, "m-portlet--sticky") && (s.eventTrigger("stickyOff"), mUtil.removeClass(l, "m-portlet--sticky"), mUtil.removeClass(o, "m-portlet--sticky"), s.resetSticky())
                    },
                    initSticky: function () {
                    ...
                    remove: function () {
                        !1 !== s.eventTrigger("beforeRemove") && (mUtil.hasClass(l, "m-portlet--fullscreen") && mUtil.hasClass(o, "m-portlet--fullscreen") && s.fullscreen("off"), s.removeTooltips(), mUtil.remove(o), s.eventTrigger("afterRemove"))
                    },
                    setContent: function (t) {
                    ...
                    setupTooltips: function () {
                        if (n.options.tooltips) {
                            ...
                            if (i) {
                                var r = e ? "bottom" : "top",
                                    s = new Tooltip(i, {
                                        ...
                                        trigger: "hover",
                                        template: '<div class="m-tooltip m-tooltip--portlet tooltip bs-tooltip-' + r + '" role="tooltip">                            <div class="tooltip-arrow arrow"></div>                            <div class="tooltip-inner"></div>                        </div>'
                                    });
                                mUtil.data(i).set("tooltip", s)
                            }
                            var a = mUtil.find(n.head, "[m-portlet-tool=reload]");
                            if (a) {
                                r = e ? "bottom" : "top", s = new Tooltip(a, {
                            ...
                            if (m) {
                                r = e ? "bottom" : "top", s = new Tooltip(m, {
                            ...
                            if (d) {
                                r = e ? "bottom" : "top", s = new Tooltip(d, {
                    ...
                    expand: function () {
                        if (!1 !== s.eventTrigger("beforeExpand")) {
                            ...
                            }), mUtil.removeClass(o, "m-portlet--collapse"), mUtil.removeClass(o, "m-portlet--collapsed");
                            var t = mUtil.find(n.head, "[m-portlet-tool=toggle]");
                            t && mUtil.data(t).has("tooltip") && mUtil.data(t).get("tooltip").updateTitleContent(n.options.tools.toggle.collapse)
                        }
                    },
                    fullscreen: function (t) {
                        if ("off" === t || mUtil.hasClass(l, "m-portlet--fullscreen") && mUtil.hasClass(o, "m-portlet--fullscreen")) s.eventTrigger("beforeFullscreenOff"), mUtil.removeClass(l, "m-portlet--fullscreen"), mUtil.removeClass(o, "m-portlet--fullscreen"), s.removeTooltips(), s.setupTooltips(), n.foot && (mUtil.css(n.body, "margin-bottom", ""), mUtil.css(n.foot, "margin-top", "")), s.eventTrigger("afterFullscreenOff");
                        else {
        ...
        if (o) {
            var l = {
                ...
                r = {
                    ...
                    init: function (t) {
                        n.element = o, n.events = [], n.options = mUtil.deepExtend({}, l, t), n.target = mUtil.get(n.options.target), n.targetState = n.options.targetState, n.togglerState = n.options.togglerState, n.state = mUtil.hasClasses(n.target, n.targetState) ? "on" : "off"
                    },
                    build: function () {
        ...
        if (o) {
            var r = {
                ...
                s = {
                    ...
                    init: function (t) {
                        n.element = o, n.events = [], n.options = mUtil.deepExtend({}, r, t), n.query = "", n.form = mUtil.find(o, "form"), n.input = mUtil.get(n.options.inputTarget), n.iconClose = mUtil.get(n.options.iconCloseTarget), "default" == n.options.mode && (n.iconSearch = mUtil.get(n.options.iconSearchTarget), n.iconCancel = mUtil.get(n.options.iconCancelTarget)), n.dropdown = new mDropdown(o, {
                            mobileOverlay: !1
                        }), n.cancelTimeout, n.processing = !1, n.requestTimeout = !1
                    },
                    build: function () {
                        mUtil.addEvent(n.input, "keyup", s.search), "default" == n.options.mode ? (mUtil.addEvent(n.input, "focus", s.showDropdown), mUtil.addEvent(n.iconCancel, "click", s.handleCancel), mUtil.addEvent(n.iconSearch, "click", function () {
