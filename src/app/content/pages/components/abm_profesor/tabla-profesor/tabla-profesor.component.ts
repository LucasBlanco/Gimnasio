	...
	template: `
		<div class="m-portlet m-portlet--success m-portlet--head-solid-bg">
			...
			<div class="m-portlet__body">
				<m-tabla [nombreColumnas]="['/*Nombre', '/*Apellido', 'Telefono', 'Mail', 'Domicilio', 'Sueldo', 'Dia de cobro', 'Intervalo de cobro']" 
				[valorColumnas]="['nombre', 'apellido','telefono', 'email', 'domicilio', 'sueldo', 'diaCobro', 'intervaloCobro']" 
